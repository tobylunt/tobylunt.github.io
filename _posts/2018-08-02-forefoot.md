...
placing up next to the original forefoot. Once in position, we could
trace the exact shape of the existing piece to create a rough-cut
piece.
...
white oak. A solid piece would have been better for this purpose, but
we had access to G-Flex and the 2" planks and decided that urgency
...
always replace this piece again in 10 years or so. So we went ahead
with our plan and laminated the pieces together to accommodate our
template. Can never have enough clamps!
...
and then spiling the finished line. Cuts were made on Scott's fancy
new Laguna bandsaw.

![Ariadne]({{ tobylunt.github.io }}/assets/img/forefoot_cut_to_shape.jpg "Cutting to shape")

At the end of this process, Scott had built a nice square blank to
match the template we had made. He brought the template to the boat to
...
needed to be removed - and were complete corroded away. Bronze wood
screws fastening plank ends to forefoot rabbet needed to be backed
out. Many broke or were spinners, needing special attention.
...
replacement. Hood ends of planks (as well as butt block joints) are
...
## SHAPING, AND CUTTING THE RABBET
...
piece of white oak. Note that the square holes are for the bungs
covering the floor timber bolts, originally made out of iron.
...
![Ariadne]({{ tobylunt.github.io }}/assets/img/forefoot_rabbet_comparison.png "Rabbet types")
...
shape. The photo below shows the testing of the rabbet, before the
...
was previously a interior void that trapped water with no possibility
...
![Ariadne]({{ tobylunt.github.io }}/assets/img/cobra_head_rough.jpg "Cobra head rough")
...
to cut stopwaters for these joints, but will do so using softwood
dowels.
