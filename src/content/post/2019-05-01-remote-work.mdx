...
making as many parts as you can remotely, then installing them _in situ_.

The most recent escapade on this front has involved working towards
 three primary goals:

1. Laminate 20 frame blanks for installation in the forward
...
2. Strengthen and refinish three cockpit benches, four
  lazarettes, and various pieces of cabin and cockpit sole;
3. Build a new, much larger mast step to adequately transfer the loads
...
Unfortunately, Ariadne has cracks in nearly two thirds of her
...
1. Screw 2x4 blocks to the table with a 5/8" offset
2. Plastic sheeting (trash bags)
3. Glue up
4. Clean up
