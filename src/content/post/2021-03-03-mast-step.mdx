...
<CaptionedImage
  src={mastStepOffset}
  alt="Ariadne"
  caption="Mast in blue, mast step in red, lead ballast in green. The small green circle represents the approximate center of righting moment induced by the hunk of lead. Notice the fore-and-aft offset between the mast and the green circle."
/>
...
<CaptionedImage src={stepChisel} alt="Mast step chisel" caption="Fine tuning the slots." />
...
<CaptionedImage src={stepDrill} alt="Mast step drilling" caption="Don't mess it up." />
...
<CaptionedImage src={boltDrive} alt="Mast step bolt driving" caption="Don't miss." />
